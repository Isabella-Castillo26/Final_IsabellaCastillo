...
map.getView().fit([-78.896224, -6.821195, -78.659638, -6.614523], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mapa de provincias de Cajamarca</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (138 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Este mapa fue elaborado para el examen final del curso de Cartografía y SIG<br />UPN-2025<br />Estudiante de Ing. Ambiental Isabella Castillo Huaman';
            }
